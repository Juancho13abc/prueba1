document.addEventListener('DOMContentLoaded', () => {
    ...
    productos.forEach((producto) => {
        ...
        botonCarrito.addEventListener('click', () => {
            ...
            const codigo = producto.querySelector('p:nth-of-type(5) strong').textContent; // Obtener el código del producto
            ...
            if (productoExistente) {
                ...
                carrito.push({ nombre, precioTexto, precioNumerico, cantidad, imagen, codigo });
            }
    ...
    sincronizarCarrito(); // Sincronizar el carrito al cargar la página
});
